savedcmd_arch/x86/tools/relocs_common.o := gcc -Wp,-MMD,arch/x86/tools/.relocs_common.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu11   -I ./scripts/include -Werror -I./tools/include -I./include/uapi -I./arch//include/uapi  -c -o arch/x86/tools/relocs_common.o arch/x86/tools/relocs_common.c
