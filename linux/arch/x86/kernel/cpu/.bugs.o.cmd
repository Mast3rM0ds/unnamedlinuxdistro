...
deps_arch/x86/kernel/cpu/bugs.o := \
    ...
    $(wildcard include/config/MITIGATION_SPECTRE_V2) \
    $(wildcard include/config/SMP) \
    $(wildcard include/config/SECCOMP) \
    $(wildcard include/config/MITIGATION_IBRS_ENTRY) \
    $(wildcard include/config/MITIGATION_SPECTRE_BHI) \
    $(wildcard include/config/X86_64) \
    $(wildcard include/config/BPF_JIT) \
    $(wildcard include/config/MITIGATION_TSA) \
    $(wildcard include/config/MITIGATION_SSB) \
    $(wildcard include/config/MITIGATION_L1TF) \
    $(wildcard include/config/KVM_INTEL) \
    $(wildcard include/config/PGTABLE_LEVELS) \
    $(wildcard include/config/MITIGATION_SRSO) \
    $(wildcard include/config/MITIGATION_VMSCAPE) \
