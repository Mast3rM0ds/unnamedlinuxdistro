savedcmd_vmlinux.unstripped := scripts/link-vmlinux.sh "ld" "-m elf_x86_64 --fatal-warnings -z noexecstack --no-warn-rwx-segments" "-z max-page-size=0x200000 --build-id=sha1 --orphan-handling=error --emit-relocs --discard-none" "vmlinux.unstripped";  true
