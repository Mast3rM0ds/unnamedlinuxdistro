...
static int
constant_14 (pTHX_ const char *name, IV *iv_return, const char **pv_return) {
  /* When generated this function returned values for the list of names given
     here.  However, subsequent manual editing may have added or removed some.
     ZLIBNG_VERSION Z_HUFFMAN_ONLY Z_STREAM_ERROR */
  ...
  case 'F':
    ...
    break;
  case 'G':
    if (memEQ(name, "ZLIBNG_VERSION", 14)) {
    /*                    ^               */
#ifdef ZLIBNG_VERSION
      *pv_return = ZLIBNG_VERSION;
      return PERL_constant_ISPV;
#else
      return PERL_constant_NOTDEF;
#endif
...
constant_16 (pTHX_ const char *name, IV *iv_return) {
  /* When generated this function returned values for the list of names given
     here.  However, subsequent manual editing may have added or removed some.
     ZLIBNG_VER_MAJOR ZLIBNG_VER_MINOR Z_NO_COMPRESSION */
  ...
  case 'I':
    ...
    break;
  case 'J':
    if (memEQ(name, "ZLIBNG_VER_MAJOR", 16)) {
    /*                            ^         */
#ifdef ZLIBNG_VER_MAJOR
      *iv_return = ZLIBNG_VER_MAJOR;
      return PERL_constant_ISIV;
#else
      return PERL_constant_NOTDEF;
#endif
    ...
    break;
  case 'N':
    if (memEQ(name, "ZLIBNG_VER_MINOR", 16)) {
    /*                            ^         */
#ifdef ZLIBNG_VER_MINOR
      *iv_return = ZLIBNG_VER_MINOR;
      return PERL_constant_ISIV;
#else
      return PERL_constant_NOTDEF;
#endif
...
my $types = {map {($_, 1)} qw(IV PV UV)};
my @names = (qw(DEF_WBITS MAX_MEM_LEVEL MAX_WBITS OS_CODE ZLIBNG_VERNUM
	       ZLIBNG_VER_MAJOR ZLIBNG_VER_MINOR ZLIBNG_VER_MODIFIED
	       ZLIBNG_VER_REVISION Z_ASCII Z_BEST_COMPRESSION Z_BEST_SPEED
	       Z_BINARY Z_BLOCK Z_BUF_ERROR Z_DATA_ERROR Z_DEFAULT_COMPRESSION
	       Z_DEFAULT_STRATEGY Z_DEFLATED Z_ERRNO Z_FILTERED Z_FINISH
	       Z_FIXED Z_FULL_FLUSH Z_HUFFMAN_ONLY Z_MEM_ERROR Z_NEED_DICT
	       Z_NO_COMPRESSION Z_NO_FLUSH Z_OK Z_PARTIAL_FLUSH Z_RLE
	       Z_STREAM_END Z_STREAM_ERROR Z_SYNC_FLUSH Z_UNKNOWN
	       Z_VERSION_ERROR),
            {name=>"ZLIBNG_VERSION", type=>"PV"},
...
__END__
  ...
  case 13:
    ...
    /* MAX_MEM_LEVEL ZLIBNG_VERNUM */
    /* Offset 12 gives the best switch position.  */
    switch (name[12]) {
    case 'L':
      if (memEQ(name, "MAX_MEM_LEVE", 12)) {
      /*                           L      */
#ifdef MAX_MEM_LEVEL
      ...
      break;
    case 'M':
      if (memEQ(name, "ZLIBNG_VERNU", 12)) {
      /*                           M      */
#ifdef ZLIBNG_VERNUM
        *iv_return = ZLIBNG_VERNUM;
        return PERL_constant_ISIV;
#else
        return PERL_constant_NOTDEF;
#endif
    ...
    break;
  case 14:
    return constant_14 (aTHX_ name, iv_return, pv_return);
    break;
  case 15:
  ...
  case 19:
    ...
    /* ZLIBNG_VER_MODIFIED ZLIBNG_VER_REVISION */
    /* Offset 11 gives the best switch position.  */
    switch (name[11]) {
    case 'M':
      if (memEQ(name, "ZLIBNG_VER_MODIFIED", 19)) {
      /*                          ^              */
#ifdef ZLIBNG_VER_MODIFIED
        *iv_return = ZLIBNG_VER_MODIFIED;
        return PERL_constant_ISIV;
#else
        return PERL_constant_NOTDEF;
#endif
      ...
      break;
    case 'R':
      if (memEQ(name, "ZLIBNG_VER_REVISION", 19)) {
      /*                          ^              */
#ifdef ZLIBNG_VER_REVISION
        *iv_return = ZLIBNG_VER_REVISION;
        return PERL_constant_ISIV;
#else
        return PERL_constant_NOTDEF;
#endif
