...
XS_EUPXS(XS_Hash__Util__FieldHash_id)
{
	...
	SV*	ref = ST(0)
;
#line 390 "FieldHash.xs"
    if (SvROK(ref)) {
        XPUSHs(HUF_obj_id(aTHX_ ref));
    } else {
        XPUSHs(ref);
    }
#line 574 "FieldHash.c"
	PUTBACK;
	return;
    }
}
