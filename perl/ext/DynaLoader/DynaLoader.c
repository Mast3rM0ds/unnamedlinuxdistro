...
XS_EUPXS(XS_DynaLoader_dl_undef_symbols)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 265 "DynaLoader.xs"
#line 478 "DynaLoader.c"
    }
    XSRETURN_EMPTY;
}
