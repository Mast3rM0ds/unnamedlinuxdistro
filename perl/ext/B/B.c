...
XS_EUPXS(XS_B__SV_IsBOOL); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_B__SV_IsBOOL)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "sv");
...
XS_EUPXS(XS_B__SV_TRUE); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_B__SV_TRUE)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "sv");
...
XS_EUPXS(XS_B__SV_TRUE_nomg); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_B__SV_TRUE_nomg)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "sv");
...
XS_EUPXS(XS_B__PADNAME_IsUndef); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_B__PADNAME_IsUndef)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "padn");
    {
	B__PADNAME	padn;
	bool	RETVAL;
	...
	if (SvROK(ST(0))) {
	    IV tmp = SvIV((SV*)SvRV(ST(0)));
	    padn = INT2PTR(B__PADNAME,tmp);
	}
	else
	    croak("padn is not a reference")
;
#line 2420 "B.xs"
...
#  endif
...

    {
        ...
        newXS_deffile("B::SV::IsBOOL", XS_B__SV_IsBOOL);
        newXS_deffile("B::SV::TRUE", XS_B__SV_TRUE);
        newXS_deffile("B::SV::TRUE_nomg", XS_B__SV_TRUE_nomg);
        ...
        cv = newXS_deffile("B::PADNAME::GEN", XS_B__PADNAME_TYPE);
        XSANY.any_i32 = PN_xpadn_gen_ix;
        ...
        newXS_deffile("B::PADNAME::IsUndef", XS_B__PADNAME_IsUndef);
    ...
    static const struct uv_s values_for_uv[] =
      {
        ...
        { "COP_FEATURE_SIZE", 16, COP_FEATURE_SIZE },
        { "RCPVf_USE_STRLEN", 16, RCPVf_USE_STRLEN },
        { "RCPVf_NO_COPY", 13, RCPVf_NO_COPY },
        { "RCPVf_ALLOW_EMPTY", 17, RCPVf_ALLOW_EMPTY },
        ...
        { "PERLSI_SMARTMATCH", 17, PERLSI_SMARTMATCH },
        { "PERLSI_CONSTRUCTOR", 18, PERLSI_CONSTRUCTOR },
        { "CVf_NOWARN_AMBIGUOUS", 20, CVf_NOWARN_AMBIGUOUS },
        ...
        { "CVf_REFCOUNTED_ANYSV", 20, CVf_REFCOUNTED_ANYSV },
        { "CVf_IsMETHOD", 12, CVf_IsMETHOD },
        { "CVf_XS_RCSTACK", 14, CVf_XS_RCSTACK },
        { "CVf_EVAL_COMPILED", 17, CVf_EVAL_COMPILED },
        { "GVf_INTRO", 9, GVf_INTRO },
        { "GVf_MULTI", 9, GVf_MULTI },
        { "GVf_ASSUMECV", 12, GVf_ASSUMECV },
        { "GVf_RESERVED", 12, GVf_RESERVED },
        ...
        { "GVf_ONCE_FATAL", 14, GVf_ONCE_FATAL },
        { "OPf_WANT", 8, OPf_WANT },
        ...
        { "XOPf_xop_dump", 13, XOPf_xop_dump },
        ...
        { "OPpTRANS_SHIFT", 14, OPpTRANS_SHIFT },
        ...
        { "OPpTRANS_ONLY_UTF8_INVARIANTS", 29, OPpTRANS_ONLY_UTF8_INVARIANTS },
        { "OPpARGELEM_AV", 13, OPpARGELEM_AV },
        { "OPpCONST_NOVER", 14, OPpCONST_NOVER },
        { "OPpCONST_TOKEN_BITS", 19, OPpCONST_TOKEN_BITS },
        ...
        { "OPpINITFIELD_AV", 15, OPpINITFIELD_AV },
        { "OPpITER_REVERSED", 16, OPpITER_REVERSED },
        { "OPpMETH_NO_BAREWORD_IO", 22, OPpMETH_NO_BAREWORD_IO },
        { "OPpSORT_INTEGER", 15, OPpSORT_INTEGER },
        { "OPpTRANS_BITS", 13, OPpTRANS_BITS },
        ...
        { "OPpTRANS_MASK", 13, OPpTRANS_MASK },
        ...
        { "OPpINITFIELD_HV", 15, OPpINITFIELD_HV },
        { "OPpITER_INDEXED", 15, OPpITER_INDEXED },
        ...
        { "OPpCONST_TOKEN_SHIFT", 20, OPpCONST_TOKEN_SHIFT },
        ...
        { "OPpITER_REFALIAS", 16, OPpITER_REFALIAS },
        ...
        { "OPpEMPTYAVHV_IS_HV", 18, OPpEMPTYAVHV_IS_HV },
        ...
        { "OPpHELEMEXISTSOR_DELETE", 23, OPpHELEMEXISTSOR_DELETE },
        { "OPpINITFIELDS", 13, OPpINITFIELDS },
        { "OPpLVALUE", 9, OPpLVALUE },
        { "OPpLVAL_INTRO", 13, OPpLVAL_INTRO },
        { "OPpOFFBYONE", 11, OPpOFFBYONE },
        { "OPpOPEN_OUT_CRLF", 16, OPpOPEN_OUT_CRLF },
        { "OPpPARAM_IF_UNDEF", 17, OPpPARAM_IF_UNDEF },
        { "OPpPV_IS_UTF8", 13, OPpPV_IS_UTF8 },
        { "OPpTRANS_DELETE", 15, OPpTRANS_DELETE },
        { "OPpCONST_TOKEN_MASK", 19, OPpCONST_TOKEN_MASK },
        { "OPpCONST_TOKEN_PACKAGE", 22, OPpCONST_TOKEN_PACKAGE },
        ...
        { "PADNAMEf_OUTER", 14, PADNAMEf_OUTER },
        { "PADNAMEf_STATE", 14, PADNAMEf_STATE },
        { "PADNAMEf_LVALUE", 15, PADNAMEf_LVALUE },
        { "PADNAMEf_TYPED", 14, PADNAMEf_TYPED },
        { "PADNAMEf_OUR", 12, PADNAMEf_OUR },
        { "PADNAMEf_FIELD", 14, PADNAMEf_FIELD },
