...
#line 161 "attributes.xs"
    SV *rv, *sv;
#line 330 "attributes.c"
#line 164 "attributes.xs"
    if (items < 1) {
usage:
...
XS_EUPXS(XS_attributes__fetch_attrs)
{
    ...
    SP -= items;
    {
#line 182 "attributes.xs"
    SV *rv, *sv;
    cv_flags_t cvflags;
#line 364 "attributes.c"
#line 185 "attributes.xs"
    if (items != 1) {
usage:
...
XS_EUPXS(XS_attributes__guess_stash)
{
    ...
    SP -= items;
    {
#line 213 "attributes.xs"
    SV *rv, *sv;
    dXSTARG;
#line 408 "attributes.c"
#line 216 "attributes.xs"
    if (items != 1) {
usage:
	croak_xs_usage(cv, "$reference");
    }
