...
"x86_64\-linux-7\.1\.4\-200\.nobara\.fc44\.x86_64" or
	die "Errno architecture (x86_64\-linux-7\.1\.4\-200\.nobara\.fc44\.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
