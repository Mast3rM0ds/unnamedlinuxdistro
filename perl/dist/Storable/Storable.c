...
XS_EUPXS(XS_Storable_init_perinterp)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 7782 "Storable.xs"
    init_perinterp(aTHX);
#line 7927 "Storable.c"
    }
    XSRETURN_EMPTY;
}
...
#line 7834 "Storable.xs"
    RETVAL = pretrieve(aTHX_ f, flag);
#line 8004 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
#line 7843 "Storable.xs"
    RETVAL = mretrieve(aTHX_ sv, flag);
#line 8032 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
;
	SV *	RETVAL;
#line 7851 "Storable.xs"
    RETVAL = dclone(aTHX_ sv);
#line 8052 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
XS_EUPXS(XS_Storable_last_op_in_netorder)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 7861 "Storable.xs"
    bool result;
#line 8070 "Storable.c"
	SV *	RETVAL;
#line 7863 "Storable.xs"
    if (ix) {
        dSTCXT;
        assert(cxt);
