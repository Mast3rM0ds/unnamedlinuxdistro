...
XS_EUPXS(XS_threads_self)
{
    ...
    PERL_UNUSED_VAR(items); /* -W */
    {
#line 1289 "threads.xs"
        char *classname;
        ithread *thread;
#line 1482 "threads.c"
	SV *	RETVAL;
#line 1292 "threads.xs"
        /* Class method only */
...
XS_EUPXS(XS_threads_kill)
{
    ...
    SP -= items;
    {
#line 1502 "threads.xs"
        ithread *thread;
        char *sig_name;
        IV signal;
        int no_handler = 1;
#line 1756 "threads.c"
#line 1507 "threads.xs"
...
XS_EUPXS(XS_threads_equal)
{
    ...
    PERL_UNUSED_VAR(items); /* -W */
    {
#line 1567 "threads.xs"
        int are_equal = 0;
#line 1838 "threads.c"
	IV	RETVAL;
	dXSTARG;
#line 1569 "threads.xs"
        PERL_UNUSED_VAR(items);
...
XS_EUPXS(XS_threads_is_running)
{
    ...
    PERL_UNUSED_VAR(items); /* -W */
    {
#line 1714 "threads.xs"
        ithread *thread;
#line 2049 "threads.c"
	SV *	RETVAL;
#line 1716 "threads.xs"
        /* Object method only */
        if ((items != 1) || ! sv_isobject(ST(0))) {
...
XS_EUPXS(XS_threads_is_detached)
{
    ...
    PERL_UNUSED_VAR(items); /* -W */
    {
#line 1731 "threads.xs"
        ithread *thread;
#line 2078 "threads.c"
	SV *	RETVAL;
#line 1733 "threads.xs"
        PERL_UNUSED_VAR(items);
        thread = S_SV_to_ithread(aTHX_ ST(0));
        MUTEX_LOCK(&thread->mutex);
...
XS_EUPXS(XS_threads_is_joinable)
{
    ...
    PERL_UNUSED_VAR(items); /* -W */
    {
#line 1744 "threads.xs"
        ithread *thread;
#line 2103 "threads.c"
	SV *	RETVAL;
#line 1746 "threads.xs"
        /* Object method only */
        if ((items != 1) || ! sv_isobject(ST(0))) {
...
XS_EUPXS(XS_threads_wantarray)
{
    ...
    PERL_UNUSED_VAR(items); /* -W */
    {
#line 1763 "threads.xs"
        ithread *thread;
#line 2134 "threads.c"
	SV *	RETVAL;
#line 1765 "threads.xs"
        PERL_UNUSED_VAR(items);
        thread = S_SV_to_ithread(aTHX_ ST(0));
...
XS_EUPXS(XS_threads_set_thread_exit_only)
{
    ...
    PERL_UNUSED_VAR(items); /* -W */
    {
#line 1776 "threads.xs"
        ithread *thread;
#line 2159 "threads.c"
#line 1778 "threads.xs"
        if (items != 2) {
...
XS_EUPXS(XS_threads_error)
{
    ...
    PERL_UNUSED_VAR(items); /* -W */
    {
#line 1800 "threads.xs"
        ithread *thread;
        SV *err = NULL;
#line 2194 "threads.c"
	SV *	RETVAL;
#line 1803 "threads.xs"
        /* Object method only */
        if ((items != 1) || ! sv_isobject(ST(0))) {
