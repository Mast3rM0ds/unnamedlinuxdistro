...
case "$perladmin" in
'') perladmin='sonakrie@nobara-laptop.(none)' ;;
esac
...
case "$prefix" in
'') prefix='/home/sonakrie/Work/testicular_linux/fs' ;;
esac
...
case "$siteprefix" in
'') if test "/home/sonakrie/Work/testicular_linux/fs" = "/home/sonakrie/Work/testicular_linux/fs"; then
	siteprefix="$prefix"
    else
	siteprefix='/home/sonakrie/Work/testicular_linux/fs'
    fi
    ;;
esac
case "$vendorprefix" in
'') if test "" = "/home/sonakrie/Work/testicular_linux/fs"; then
	vendorprefix="$prefix"
    else
	vendorprefix=''
    fi
...
'') if test "/home/sonakrie/Work/testicular_linux/fs" = "/home/sonakrie/Work/testicular_linux/fs"; then
	...
	installprefix='/home/sonakrie/Work/testicular_linux/fs'
    fi
    ;;
esac
...
#     /home/sonakrie/Work/testicular_linux/fs, so it isn't included here either.
#
...
# bin='/home/sonakrie/Work/testicular_linux/fs/bin'
# scriptdir='/home/sonakrie/Work/testicular_linux/fs/bin'
# privlib='/home/sonakrie/Work/testicular_linux/fs/lib/perl5/5.44.0'
# archlib='/home/sonakrie/Work/testicular_linux/fs/lib/perl5/5.44.0/x86_64-linux'
...
html3dir=' '
# sitebin='/home/sonakrie/Work/testicular_linux/fs/bin'
# sitescript='/home/sonakrie/Work/testicular_linux/fs/bin'
# sitelib='/home/sonakrie/Work/testicular_linux/fs/lib/perl5/site_perl/5.44.0'
# sitearch='/home/sonakrie/Work/testicular_linux/fs/lib/perl5/site_perl/5.44.0/x86_64-linux'
