...
#if defined __need_system_fcntl_h || defined _GL_M4_ALREADY_INCLUDING_FCNTL_H
...
#if (IN_M4_GNULIB_TESTS || 1 || defined GNULIB_POSIXCHECK) \
...
#define _GL_M4_ALREADY_INCLUDING_FCNTL_H
...
#undef _GL_M4_ALREADY_INCLUDING_FCNTL_H
