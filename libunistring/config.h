...
#define GNULIB_ACCEPT IN_LIBUNISTRING_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module bind shall be considered present. */
#define GNULIB_BIND IN_LIBUNISTRING_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module close shall be considered present. */
#define GNULIB_CLOSE IN_LIBUNISTRING_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module connect shall be considered present. */
#define GNULIB_CONNECT IN_LIBUNISTRING_GNULIB_TESTS
...
#define GNULIB_FSTAT IN_LIBUNISTRING_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module ioctl shall be considered present. */
#define GNULIB_IOCTL IN_LIBUNISTRING_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module isblank shall be considered present. */
#define GNULIB_ISBLANK IN_LIBUNISTRING_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module listen shall be considered present. */
#define GNULIB_LISTEN IN_LIBUNISTRING_GNULIB_TESTS
...
#define GNULIB_LOCALEDIR "/home/bloink/Work/unnamedlinuxdistro/fs/share/locale"
...
#define GNULIB_LSTAT IN_LIBUNISTRING_GNULIB_TESTS
...
#define GNULIB_REALLOCARRAY IN_LIBUNISTRING_GNULIB_TESTS
...
#define GNULIB_SELECT IN_LIBUNISTRING_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module setsockopt shall be considered present. */
#define GNULIB_SETSOCKOPT IN_LIBUNISTRING_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module socket shall be considered present. */
#define GNULIB_SOCKET IN_LIBUNISTRING_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module stat shall be considered present. */
#define GNULIB_STAT IN_LIBUNISTRING_GNULIB_TESTS
...
#define GNULIB_STRERROR_R_POSIX IN_LIBUNISTRING_GNULIB_TESTS
...
#define GNULIB_XALLOC IN_LIBUNISTRING_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module xalloc-die shall be considered present. */
#define GNULIB_XALLOC_DIE IN_LIBUNISTRING_GNULIB_TESTS
...
#define INSTALLPREFIX "/home/bloink/Work/unnamedlinuxdistro/fs"
...
#define PACKAGE_NAME "libunistring"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "libunistring 1.4.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "libunistring"
