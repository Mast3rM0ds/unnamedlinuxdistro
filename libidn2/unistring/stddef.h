...
# if !(defined _GL_UNISTRING_STDDEF_H && defined _GL_UNISTRING_STDDEF_WINT_T)
#  ifdef __need_wint_t
#   define _GL_UNISTRING_STDDEF_WINT_T
#  endif
...
#  if (0 \
       && (!defined _GL_UNISTRING_STDDEF_H || defined _GL_UNISTRING_STDDEF_WINT_T))
#   undef NULL
#   ifdef __cplusplus
