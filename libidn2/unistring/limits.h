...
#if defined _GL_UNISTRING_ALREADY_INCLUDING_LIMITS_H
...
#ifndef _GL_UNISTRING_LIMITS_H

# define _GL_UNISTRING_ALREADY_INCLUDING_LIMITS_H

/* The include_next requires a split double-inclusion guard.  */
# include_next <limits.h>

# undef _GL_UNISTRING_ALREADY_INCLUDING_LIMITS_H

#ifndef _GL_UNISTRING_LIMITS_H
#define _GL_UNISTRING_LIMITS_H
