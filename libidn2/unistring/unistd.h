...
#if !defined _GL_UNISTRING_UNISTD_H && !defined _GL_INCLUDING_WINSOCK2_H
#define _GL_UNISTRING_UNISTD_H
...
#if 0 && 0
# if !defined _GL_UNISTRING_SYS_SOCKET_H
#  if !(defined __cplusplus && defined GNULIB_NAMESPACE)
#   undef socket
...
#  endif
# endif
# if !defined _GL_UNISTRING_SYS_SELECT_H
#  if !(defined __cplusplus && defined GNULIB_NAMESPACE)
#   undef select
