...
#define GNULIB_ACCEPT IN_SED_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module bind shall be considered present. */
#define GNULIB_BIND IN_SED_GNULIB_TESTS
...
#define GNULIB_CONNECT IN_SED_GNULIB_TESTS
...
#define GNULIB_IOCTL IN_SED_GNULIB_TESTS
...
#define GNULIB_LISTEN IN_SED_GNULIB_TESTS
...
#define GNULIB_SELECT IN_SED_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module setsockopt shall be considered present. */
#define GNULIB_SETSOCKOPT IN_SED_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module socket shall be considered present. */
#define GNULIB_SOCKET IN_SED_GNULIB_TESTS
...
#define PACKAGE_STRING "GNU sed 4.10"
