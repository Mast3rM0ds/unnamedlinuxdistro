...
(*.[0-9]*)
	...
	if test ! -f "/home/sonakrie/Work/testicular_linux/ncurses-6.5/man_alias.sed" ; then
cat >>/home/sonakrie/Work/testicular_linux/ncurses-6.5/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/sonakrie/Work/testicular_linux/ncurses-6.5/man_alias.sed"
	fi
	...
	aliases=`sed -f "$top_srcdir/man/manlinks.sed" "$cf_full_alias" |sed -f "/home/sonakrie/Work/testicular_linux/ncurses-6.5/man_alias.sed" | sort -u; test "$cf_part_alias" = "$nCurses" && echo curses`
	...
	sed	-f "/home/sonakrie/Work/testicular_linux/ncurses-6.5/man_alias.sed" \
		< "$i" >$TMP
